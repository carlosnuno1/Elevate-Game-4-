class Level3 extends Phaser.Scene {
    ...
    init() {
        ...
        this.end = false;
        this.animationbugfix = true;
    }

    create() {
        //create world
        this.map = this.add.tilemap("platformer-level-3", 19, 19, 40, 90);

        this.tileset = this.map.addTilesetImage("thatnew", "tilemap_tiles");
        ...
        //setup player
        my.sprite.player = this.physics.add.sprite(10, 120, "platformer_characters", "tile_0000.png");
    ...
    update() {
        ...
        //bugfix
        if(this.animationbugfix){
            my.vfx.doublejump.stop();
            this.animationbugfix = false;
        }
    }
}
