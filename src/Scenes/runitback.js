class Level4 extends Phaser.Scene {
    ...
    create() {
        //create world
        this.map = this.add.tilemap("platformer-level-4", 19, 19, 40, 90);

        this.tileset = this.map.addTilesetImage("thefourth", "tilemap_tiles");
