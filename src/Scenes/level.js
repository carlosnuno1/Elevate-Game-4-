class Level2 extends Phaser.Scene {
    ...
    create() {
        //create world
        this.map = this.add.tilemap("platformer-level-2", 19, 19, 40, 90);

        this.tileset = this.map.addTilesetImage("level", "tilemap_tiles");
        ...
        //setup player
        my.sprite.player = this.physics.add.sprite(10, 300, "platformer_characters", "tile_0000.png");
